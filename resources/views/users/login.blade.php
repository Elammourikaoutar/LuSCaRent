...
<html lang="en">
  ...
  @auth
    ...
    <li class="nav-item">
      <a class="nav-link text-light" style="font-size: 18px;"href="{{route('admins.index')}}">
        Admin
      </a>
    </li>
    @endif
  ...
  @else
    <li class="nav-item">
      <a class="nav-link text-light"style="font-size: 18px;" href="{{route('users.register')}}">Sign up</a>
    </li>
    <li class="nav-item">
      <a class="nav-link text-warning"style="font-size: 18px;" href="{{route('users.login')}}">Log in</a>
    </li>
  @endauth
</ul>
 ...
 @yield('content')
        ...
        <div class="col-md-8 mx-auto p3">
            <div class="card border border-light shadow-lg p-3 mb-5 bg-body rounded">
                <h3 class="card-header bg-dark "style="color: #a38840;font-size: 35px;">Sign in</h3>
                <div class="card-body">
